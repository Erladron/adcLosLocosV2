...
[functions](../index.md) / onEventTriggerNotification

# Function: onEventTriggerNotification()

> **onEventTriggerNotification**(`raw`): `any`

Defined in: [src/functions/onEventTriggerNotification.ts:29](https://github.com/Erladron/adcLosLocosV2/blob/ef8b35066458446779d596c924480fd02bae169f/functions/src/functions/onEventTriggerNotification.ts#L29)
