...
[functions](../index.md) / reactivateUser

# Function: reactivateUser()

> **reactivateUser**(`req`, `res`): `void` \| `Promise`\<`void`\>

Defined in: [src/functions/reactivateUser.ts:26](https://github.com/Erladron/adcLosLocosV2/blob/ef8b35066458446779d596c924480fd02bae169f/functions/src/functions/reactivateUser.ts#L26)
