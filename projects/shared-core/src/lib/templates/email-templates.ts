export const EmailTemplates = {
  ...
  // ==========================================
  // PLANTILLA 1: INVITACIÓN / ONBOARDING
  // ==========================================
          ...
          <tr>
            <td style="padding: 40px 35px; background-color: #ffffff;">
              ...
              <p style="color: #475569; font-size: 15px; line-height: 1.6; margin-top: 0; margin-bottom: 24px; text-align: justify;">
                Ya está todo listo para que te unes oficialmente al ecosistema digital de la <strong>Asociación Deportiva Cultural Los Locos</strong>. Queremos que formes parte activa de nuestra comunidad, sigas de cerca cada paso de la asociación y no te pierdas ni un solo momento con nosotros.
              </p>
              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td align="center">
                    <a href="https://adcloslocos-desa.web.app/welcome?token=${tokenGenerado}" 
              ...
              <p style="color: #94a3b8; font-size: 12px; line-height: 1.5; margin-top: 40px; margin-bottom: 0; border-top: 1px solid #f1f5f9; padding-top: 20px; text-align: center;">
                ...
                <br>
                <a href="https://adcloslocos-desa.web.app/welcome?token=${tokenGenerado}" style="color: #2563eb; word-break: break-all; text-decoration: underline; display: block; margin-top: 8px;">
                  https://adcloslocos-desa.web.app/welcome?token=${tokenGenerado}
                </a>
              </p>
            </td>
          </tr>
